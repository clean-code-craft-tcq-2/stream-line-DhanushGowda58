...
int main ()
{
	...
	printf ("Minimum values are\n----------------\n%f %f\n",bms_input.temperature.temp_stat.min, bms_input.soc.soc_stat.min);
	printf ("Maximum values are\n----------------\n%f %f\n",bms_input.temperature.temp_stat.max, bms_input.soc.soc_stat.max);
	printf ("Mov Average\n----------------\n%f %f\n", bms_input.temperature.temp_stat.movAvg, bms_input.soc.soc_stat.movAvg);
